...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 09, 2018 at 08:42 AM
...
(4, 'priyak@gmail.com', 1, '11/09/18', '21/09/18', 'da', 1, '2018-10-05 04:09:19');
...
(5, 'Priya', 'priyak@gmail.com', '48467d2cc726e8847fbc51f5b0bdc1d1', '9916363065', NULL, NULL, NULL, NULL, '2018-10-05 04:08:04', NULL);
...
INSERT INTO `admin` (`id`, `username`, `password`, `updationDate`) VALUES
(1, 'VENKI', 'f925916e2754e5e03f75dd58a5733251', '18-10-2016 04:18:16');
...
(22, 0, 'VENKI@GMAIL.COM', 0x3a3a3100000000000000000000000000, '2018-10-27 08:40:36', '', 0),
(23, 0, 'admin', 0x3a3a3100000000000000000000000000, '2018-10-27 08:40:49', '', 0),
(24, 1, 'anuj.lpu1@gmail.com', 0x3a3a3100000000000000000000000000, '2018-10-27 08:41:22', '27-10-2018 02:12:20 PM', 1);
...
(7, 'VENKATESH', 'VENKI@GMAIL.COM', 'fc26e113a8e4c9b702861fd20726b911', 8888888888, NULL, NULL, NULL, NULL, NULL, '2018-10-27 08:38:31', '0000-00-00 00:00:00', 1);
...
(1, 'root', 'server', 'dbms', '{\"quick_or_custom\":\"quick\",\"what\":\"sql\",\"db_select[]\":[\"carrental\",\"cms\",\"phpmyadmin\",\"suraj\",\"test\"],\"aliases_new\":\"\",\"output_format\":\"sendit\",\"filename_template\":\"@SERVER@\",\"remember_template\":\"on\",\"charset\":\"utf-8\",\"compression\":\"none\",\"maxsize\":\"\",\"codegen_structure_or_data\":\"data\",\"codegen_format\":\"0\",\"csv_separator\":\",\",\"csv_enclosed\":\"\\\"\",\"csv_escaped\":\"\\\"\",\"csv_terminated\":\"AUTO\",\"csv_null\":\"NULL\",\"csv_structure_or_data\":\"data\",\"excel_null\":\"NULL\",\"excel_columns\":\"something\",\"excel_edition\":\"win\",\"excel_structure_or_data\":\"data\",\"htmlword_structure_or_data\":\"structure_and_data\",\"htmlword_null\":\"NULL\",\"json_structure_or_data\":\"data\",\"latex_caption\":\"something\",\"latex_structure_or_data\":\"structure_and_data\",\"latex_structure_caption\":\"Structure of table @TABLE@\",\"latex_structure_continued_caption\":\"Structure of table @TABLE@ (continued)\",\"latex_structure_label\":\"tab:@TABLE@-structure\",\"latex_relation\":\"something\",\"latex_comments\":\"something\",\"latex_mime\":\"something\",\"latex_columns\":\"something\",\"latex_data_caption\":\"Content of table @TABLE@\",\"latex_data_continued_caption\":\"Content of table @TABLE@ (continued)\",\"latex_data_label\":\"tab:@TABLE@-data\",\"latex_null\":\"\\\\textit{NULL}\",\"mediawiki_structure_or_data\":\"data\",\"mediawiki_caption\":\"something\",\"mediawiki_headers\":\"something\",\"ods_null\":\"NULL\",\"ods_structure_or_data\":\"data\",\"odt_structure_or_data\":\"structure_and_data\",\"odt_relation\":\"something\",\"odt_comments\":\"something\",\"odt_mime\":\"something\",\"odt_columns\":\"something\",\"odt_null\":\"NULL\",\"pdf_report_title\":\"\",\"pdf_structure_or_data\":\"data\",\"phparray_structure_or_data\":\"data\",\"sql_include_comments\":\"something\",\"sql_header_comment\":\"\",\"sql_use_transaction\":\"something\",\"sql_compatibility\":\"NONE\",\"sql_structure_or_data\":\"structure_and_data\",\"sql_create_table\":\"something\",\"sql_auto_increment\":\"something\",\"sql_create_view\":\"something\",\"sql_create_trigger\":\"something\",\"sql_backquotes\":\"something\",\"sql_type\":\"INSERT\",\"sql_insert_syntax\":\"both\",\"sql_max_query_size\":\"50000\",\"sql_hex_for_binary\":\"something\",\"sql_utc_time\":\"something\",\"texytext_structure_or_data\":\"structure_and_data\",\"texytext_null\":\"NULL\",\"yaml_structure_or_data\":\"data\",\"\":null,\"as_separate_files\":null,\"csv_removeCRLF\":null,\"csv_columns\":null,\"excel_removeCRLF\":null,\"htmlword_columns\":null,\"json_pretty_print\":null,\"ods_columns\":null,\"sql_dates\":null,\"sql_relation\":null,\"sql_mime\":null,\"sql_disable_fk\":null,\"sql_views_as_tables\":null,\"sql_metadata\":null,\"sql_drop_database\":null,\"sql_drop_table\":null,\"sql_if_not_exists\":null,\"sql_procedure_function\":null,\"sql_truncate\":null,\"sql_delayed\":null,\"sql_ignore\":null,\"texytext_columns\":null}');
...
('root', '[{\"db\":\"suraj\",\"table\":\"figures\"},{\"db\":\"suraj\",\"table\":\"parent_company\"},{\"db\":\"suraj\",\"table\":\"pdescription\"},{\"db\":\"suraj\",\"table\":\"founder\"},{\"db\":\"suraj\",\"table\":\"project_details\"},{\"db\":\"suraj\",\"table\":\"PDESCRIPTION\"},{\"db\":\"suraj\",\"table\":\"logininfo\"},{\"db\":\"suraj\",\"table\":\"PARENT_COMPANY\"},{\"db\":\"suraj\",\"table\":\"FOUNDER\"},{\"db\":\"suraj\",\"table\":\"PROJECT_DETAILS\"}]');
...
('root', '2018-10-05 04:00:14', '{\"collation_connection\":\"utf8mb4_unicode_ci\"}');
...
-- Database: `suraj`
--
CREATE DATABASE IF NOT EXISTS `suraj` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `suraj`;
...
CREATE TABLE `figures` (
  `pid` int(5) NOT NULL,
  `fid` int(5) NOT NULL,
  `pcost` varchar(100) DEFAULT NULL,
  `paren_val` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `figures` (`pid`, `fid`, `pcost`, `paren_val`) VALUES
(1, 12, '200000', '10000');
...
CREATE TABLE `founder` (
  ...
  `pfteamname` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `logininfo` (`email`, `username`, `password`) VALUES
('surajdma@gmail.com', 'suraj', 'suraj'),
('aiuoghuiah', 'zxihvooh', '123456');
...
CREATE TABLE `parent_company` (
  `pid` int(5) NOT NULL,
  `fid` int(5) NOT NULL,
  `paren_com` varchar(100) NOT NULL,
  `paren_cat` varchar(100) DEFAULT NULL,
  `paren_location` varchar(100) DEFAULT NULL,
  `fname` varchar(100) DEFAULT NULL,
  `fportfolio` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `parent_company` (`pid`, `fid`, `paren_com`, `paren_cat`, `paren_location`, `fname`, `fportfolio`) VALUES
(1, 12, 'sam', 'test', 'bang', 'suraj', 'student');
...
CREATE TABLE `pdescription` (
  `pid` int(5) NOT NULL,
  `pdescrip` varchar(1000) DEFAULT NULL,
  `papp` varchar(1000) DEFAULT NULL,
  `pchal` varchar(1000) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `pdescription` (`pid`, `pdescrip`, `papp`, `pchal`) VALUES
(1, 'testing purpose', 'web application', 'mysql');
...
INSERT INTO `project_details` (`pid`, `pname`, `pdesc`, `pcat`, `ploc`, `prating`, `start_date`, `status`) VALUES
(1, 'kins', 'test', '', '', '', '', 'checked');
...
--
-- Indexes for table `parent_company`
--
ALTER TABLE `parent_company`
  ADD PRIMARY KEY (`pid`,`fid`);
