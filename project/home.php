...
<a href="login.php"><button  style="background-color: white;
	...
	<img src="Logomakr_42g0sV.png" style="width:250px;border-radius:25%;  margin: 100px 500px;"
...
<div id="myModal" class="modal ">
  ...
  <div  style="background-color:#e3f2fd;" class="modal-content">
	...
	<div class="carousel" >
    <a  class="carousel-item" href="prodisplay.php"><img src="PROJECT.png"></a>
    <a class="carousel-item" href="founderdisplay.php"><img src="PROJECT (1).png"></a>
    <a class="carousel-item" href="parendisplay.php"><img src="PROJECT (2).png"></a>
    <a class="carousel-item" href="descdisplay.php"><img src="PROJECT (3).png"></a>
    <a class="carousel-item" href="costdisplay.php"><img src="PROJECT (4).png"></a>
  </div>
